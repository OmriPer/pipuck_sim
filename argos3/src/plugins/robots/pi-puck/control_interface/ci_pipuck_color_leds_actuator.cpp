...
#include "ci_pipuck_color_leds_actuator.h"
...
//       CCI_PiPuckColorLEDsActuator* pcLEDsActuator =
//          CLuaUtility::GetDeviceInstance<CCI_PiPuckColorLEDsActuator>(pt_lua_state, "leds");
//       /* Update actuator */
...
// #endif
   ...
   /****************************************/
#ifdef ARGOS_WITH_LUA
   void CCI_PiPuckColorLEDsActuator::CreateLuaState(lua_State* pt_lua_state) {
      throw CARGoSException("Lua interface for CCI_PiPuckColorLEDsActuator not implemented yet.");

      // CLuaUtility::OpenRobotStateTable(pt_lua_state, "leds");
      // CLuaUtility::AddToTable(pt_lua_state, "_instance", this);
      // CLuaUtility::AddToTable(pt_lua_state,
      //                         "set_ring_led_index",
      //                         &LuaSetPiPuckColorLEDsActuatorRingLEDIndex);
      // CLuaUtility::AddToTable(pt_lua_state,
      //                         "set_ring_leds",
      //                         &LuaSetPiPuckColorLEDsActuatorRingLEDs);
      // CLuaUtility::AddToTable(pt_lua_state,
      //                         "set_front_led",
      //                         &LuaSetPiPuckColorLEDsActuatorFrontLED);
      // CLuaUtility::AddToTable(pt_lua_state,
      //                         "set_body_led",
      //                         &LuaSetPiPuckColorLEDsActuatorBodyLED);
